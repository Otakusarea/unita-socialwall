...
public class PairedBeaconAdapter extends ArrayAdapter<Beacon> {

    public PairedBeaconAdapter(@NonNull Context context, ArrayList<Beacon> resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        txtRowItemContactID.setText(String.format("(SocialWall-ID %d)", singleBeaconItem.getId()));
