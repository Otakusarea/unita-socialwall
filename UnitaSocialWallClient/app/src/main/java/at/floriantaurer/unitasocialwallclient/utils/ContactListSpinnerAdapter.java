...
public class ContactListSpinnerAdapter extends ArrayAdapter<User> {

    private Context context;

    public ContactListSpinnerAdapter(@NonNull Context context, ArrayList<User> resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ((TextView) customView).setText(singleUserItem.getName());
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        User singleBeaconItem = getItem(position);
