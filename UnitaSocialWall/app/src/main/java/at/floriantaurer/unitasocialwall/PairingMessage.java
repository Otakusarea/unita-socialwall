...
public class PairingMessage extends UnitaMessage {

    public PairingMessage(Peer sender, Peer receiver, byte[] messageBodyRaw){
        super(6, sender, receiver, messageBodyRaw);
    }
}