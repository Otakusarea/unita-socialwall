...
public class ServiceConstants {
    ...
    public interface ACTION {
        public static String STARTFOREGROUND_ACTION = "at.floriantaurer.action.startforeground";
        public static String STOPFOREGROUND_ACTION = "at.floriantaurer.action.stopforeground";
    }
}
